    ...
    <>
      ...
      <div className="w-full flex flex-col items-center" id="about-page">
        ...
        <div className="flex items-center justify-center mt-8">
          <img src="/Digital-Micrometer.webp" alt="MRLogo" className="max-w-full h-auto" />
        </div>
        ...
        <div className="about bg-white mt-8 py-2 px-2 lg:flex-row lg:px-0">
          ...
          <div className="mt-4 text-center lg:mt-0">
            ...
            small objects with high accuracy. It's specifically used to find the diameter of round objects
            or thickness.
            </p>
          </div>
              ...
              <table className="table-auto min-w-full">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-gray-400 px-4 py-2">Series 293</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-400 px-4 py-2">Range</td>
                    <td className="border border-gray-400 px-4 py-2">0-25 mm</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-400 px-4 py-2">Resolution</td>
                    <td className="border border-gray-400 px-4 py-2">0.001 mm</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-400 px-4 py-2">Maximum permissible error</td>
                    <td className="border border-gray-400 px-4 py-2">+- 0.2 um</td>
                  </tr>
                </tbody>
              </table>
            </div>
