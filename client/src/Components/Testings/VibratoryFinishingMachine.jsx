...
function VibratoryFinishingMachine() {
  return (
    <>
      <div
      ...
      <div className="w-full flex flex-col items-center" id="about-page">
        ...
        <div className="flex items-center justify-center mt-8">
          <img src="/VibratoryFinishing.jpg" alt="MRLogo" className="max-w-full h-auto" />
        </div>
        ...
        <div className="about bg-white mt-8 py-2 px-2 lg:flex-row lg:px-0">
          ...
          <div className="mt-4 text-center lg:mt-0">
            ...
            It is used for drying and finishing different industrial materials and machinery parts.
            </p>
          </div>
              ...
              <table className="table-auto min-w-full">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-gray-400 px-4 py-2">TVBP 120 STD PO</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-400 px-4 py-2">Automation Grade</td>
                    <td className="border border-gray-400 px-4 py-2">Semi-Automatic</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-400 px-4 py-2">Material</td>
                    <td className="border border-gray-400 px-4 py-2">Mild Steel</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-400 px-4 py-2">Capacity</td>
                    <td className="border border-gray-400 px-4 py-2">200 kg/hr</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-400 px-4 py-2">Design</td>
                    <td className="border border-gray-400 px-4 py-2">Standard</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-400 px-4 py-2">Power</td>
                    <td className="border border-gray-400 px-4 py-2">5 HP</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-400 px-4 py-2">Voltage</td>
                    <td className="border border-gray-400 px-4 py-2">220 V</td>
                  </tr>
                </tbody>
              </table>
            </div>
...
export default VibratoryFinishingMachine
